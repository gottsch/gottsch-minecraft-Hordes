...
/**
 * @author Mark Gottschling on Aug 1, 2019 TODO move to GottschCore
 */
public class TemplateHolder {
	...
	public TemplateHolder(Template template, ResourceLocation location, ResourceLocation metaLocation,
			List<ResourceLocation> ruleSetLocation) {
	...
	// TODO placeholder method. In future will check if there are child templates
	// associated.
